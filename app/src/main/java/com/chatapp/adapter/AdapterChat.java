...
import com.chatapp.activities.UsersListActivity;
       ...
       /* Sender side*/
        ...
        holder.ivRForward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("image",pojoChat.getImage());
                intent.putExtra("key",pojoChat.getKey());
                intent.putExtra("for","msgForward");
